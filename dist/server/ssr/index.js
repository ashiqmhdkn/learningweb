...
import React, { Fragment, createElement, use } from "react";
...
var client_references_default = {
	"fca983fe7b7c": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_fca983fe7b7c;
	},
	"061b9fa1e40a": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_061b9fa1e40a;
	},
	"861a7b013abd": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_861a7b013abd;
	},
	"c237b91ab318": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_c237b91ab318;
	},
	"e16c1c1133d5": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_e16c1c1133d5;
	},
	"b49ea5cf04c0": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_b49ea5cf04c0;
	},
	"6efdf509a785": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_6efdf509a785;
	},
	"b5f72a92d407": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_b5f72a92d407;
	},
	"593f344dc510": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_593f344dc510;
	},
	"15c18cfaeeff": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_15c18cfaeeff;
	},
	"8c0f216c4604": async () => {
		return (await import("./assets/facade__virtual_vinext-rsc-entry-DQMQQRjG.js")).export_8c0f216c4604;
	}
};
//#endregion
	...
	return runWithNavigationContext(async () => {
		...
		try {
			...
			function VinextFlightRoot() {
				...
				const elements = normalizeAppElements(use(flightRoot));
...
//#endregion
export { withBasePath as _, getLayoutSegmentContext as a, navigateClientSide as c, usePathname as d, app_ssr_entry_default as default, ReadonlyURLSearchParams as f, toSameOriginAppPath as g, toBrowserNavigationHref as h, handleSsr, getCurrentInterceptionContext as i, prefetchRscResponse as l, resolveRelativeHref as m, ParallelSlot as n, getMountedSlotsHeader as o, notifyAppRouterTransitionStart as p, Slot as r, getPrefetchedUrls as s, Children as t, toRscUrl as u, stripBasePath as v, createAppPayloadCacheKey as y };
