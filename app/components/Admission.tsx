...
export default function Admission() {
  ...
  return (
    <section id="admission" className="py-20 px-4 bg-blue-50">
      <div className="max-w-xl mx-auto">
        <div className="text-center mb-10">
          <p className="text-orange-600 font-semibold text-sm tracking-widest uppercase mb-2">Enrol</p>
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                value={form.grade}
                onChange={handleChange}
                className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
              >
            ...
            <button
              type="submit"
              className="w-full bg-orange-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-xl transition-colors mt-2"
            >
              Submit Application
            </button>
          </form>
